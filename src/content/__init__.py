...
def pages() -> list[dict]:
    ...
    out += [
        ...
        page("/gather/retreats/", "retreats.html", "SHE Retreats", "Different places. Different experiences. Something to explore. SHE retreats are created for women who want to step away from everyday life.", "scottish-loch",
